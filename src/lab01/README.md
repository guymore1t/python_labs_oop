...
Все проверки вынесены в отдельный модуль `validate.py`. 

## Пример реализации кода

Создание билетов

![Создание](/images/lab01/01.01.png)

Сравнение билетов

![Сравнение](/images/lab01/01.02.png)

Атрибут класса

![Атрибут](/images/lab01/01.03.png)

Изменение цены через setter

![Изменение цены](/images/lab01/01.04.png)

Сценарий 1: Продажа и использование

![Сценарий 1](/images/lab01/01.05.png)

Сценарий 2: Продажа и возврат

![Сценарий 2](/images/lab01/01.06.png)

Сценарий 3: Некорректные операции

![Сценарий 3](/images/lab01/01.07.png)

Некорректное создание

![Неккоректное создание](/images/lab01/01.08.png)